    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('normal', 'Normal'), ('especial', 'Especial'), ('admin', 'Administrador')], default='normal', max_length=20)),
                ('groups', models.ManyToManyField(blank=True, related_name='usuario_groups', to='auth.group')),
                ('opciones_menu', models.ManyToManyField(blank=True, related_name='usuarios', to='mi_app.opcionmenu')),
